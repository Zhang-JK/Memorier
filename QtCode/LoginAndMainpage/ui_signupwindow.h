...
public:
    ...
    void setupUi(QMainWindow *SignUpWindow)
    {
        ...
        SignUpWindow->setStyleSheet(QString::fromUtf8("background-color:rgb(25, 195, 232);"));
        ...
        pushButton->setGeometry(QRect(240, 280, 89, 25));
        errorMsg = new QLabel(centralwidget);
        errorMsg->setObjectName(QString::fromUtf8("errorMsg"));
        errorMsg->setGeometry(QRect(190, 310, 191, 16));
    ...
    void retranslateUi(QMainWindow *SignUpWindow)
    {
        ...
        pushButton->setText(QCoreApplication::translate("SignUpWindow", "Sign Up!", nullptr));
